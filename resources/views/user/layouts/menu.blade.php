    ...
    <header id="header" class="full-header">
        ...
        <div id="header-wrap">
            ...
            <div class="container clearfix">
                ...
                <!-- Logo
                ============================================= -->
                <div id="logo">	<link rel="icon" href="{{ Storage::url(setting()->icon) }}"/>

                    <a href="index.html" class="standard-logo" data-dark-logo="images/logo-dark.png"><img src="{{ Storage::url(setting()->logo) }}" alt="Canvas Logo"></a>
                    <a href="index.html" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img src="{{ Storage::url(setting()->logo) }}" alt="Canvas Logo"></a>
                </div><!-- #logo end -->
                            ...
                            <div class="top-cart-items">
                                <div class="top-cart-item clearfix">
                                    <div class="top-cart-item-image">
                                        <a href="#"><img src="{{ url('/') }}/design/user/images/shop/small/1.jpg" alt="Blue Round-Neck Tshirt" /></a>
                                    </div>
                                ...
                                <div class="top-cart-item clearfix">
                                    <div class="top-cart-item-image">
                                        <a href="#"><img src="{{ url('/') }}/design/user/images/shop/small/6.jpg" alt="Light Blue Denim Dress" /></a>
                                    </div>
                                    <div class="top-cart-item-desc">
