...
<head>
  ...
  <!-- Tell the browser to be responsive to screen width ayaaa -->
  ...
  <link rel="stylesheet" href="{{ url('/') }}/design/admin/bower_components/datatables.net-bs/css/jquery.dataTables.min.css">
  @stack('css')
